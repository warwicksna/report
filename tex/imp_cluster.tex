...
At request, a nine machine Hadoop cluster was set up for use during this project in the department of computer science. This cluster composed a head-node, {\tt hadoopmaster}, and eight slave-nodes, {\tt hadoop\{0-7\}}.
