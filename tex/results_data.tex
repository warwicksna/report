...
The Wikipedia Talk network\url{http://snap.stanford.edu/data/wiki-Talk.html} contains 2,394,385 nodes and 5,021,410 edges. There are 9,203,519 triangles present within the network, and the network as an average clustering coefficient of 0.1958.

\subsection{Patent citation}
The Patent citation network\url{http://snap.stanford.edu/data/cit-Patents.html} contains 3,774,768 nodes and 16,518,948 edges. There are 7,515,023 triangles present within the network, and the network as an average clustering coefficient of 0.0919.

\subsection{LiveJournal}
\url{http://snap.stanford.edu/data/soc-LiveJournal1.html}
...
We have shown that the system we have produced has been able to process social networks of a much larger size than possible 