...
\subsection{Hadoop}
Hadoop is framework for performing distributed computing. It is a free implementation of Google's MapReduce framework and Google File System papers.

\subsubsection{Hadoop Distributed File System}
Hadoop also provides a the Hadoop Distributed File System, HDFS. The HDFS 